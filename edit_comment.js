async function editComment(commentId) {
    ...
    try {
        ...
        const commentResponse = await fetch(`https://social-media-phibook-deployment.vercel.app/posts/allcomment/?comment_id=${commentId}`, {
            method: 'GET',
            headers: {
                'Authorization': `Token ${token}`,
                'Content-Type': 'application/json'
...
async function saveComment(commentId) {
    ...
    try {
        ...
        // Update the comment
        const updateResponse = await fetch(`https://social-media-phibook-deployment.vercel.app/posts/allcomment/`, {
            method: 'PUT',
            headers: {
                'Authorization': `Token ${token}`,
                'Content-Type': 'application/json'
